...
export const qrCodeProps = writable<QrCodeProperties>({generateQrCodes: false, salivaDistances: '', contact: '', checkDuplicates: false, enableManualScan: false});

export const studyPropsValid = writable(false);
export const barcodePropsValid = writable(false);
export const qrCodePropsValid = writable(false);
