...
const defaultQrCodeProps: QrCodeProperties = { generateQrCodes: true, salivaDistances: [], salivaTimes: [], contact: '', checkDuplicates: false, enableManualScan: false }
