<script lang="ts">
    ...
    // page properties
    let colDist = get(barcodeProps).colDist + "mm";
    let rowDist = get(barcodeProps).rowDist + "mm";
    let paddingRight= get(barcodeProps).rightMargin + "mm"; 
    let paddingLeft = get(barcodeProps).leftMargin + "mm";
    let paddingTop = get(barcodeProps).topMargin + "mm";
    let paddingBottom = get(barcodeProps).bottomMargin + "mm";
